        ...
        <div class="d-flex flex-column align-content-end">
          <div class="app-auth-body mx-auto">
            ...
            <div class="auth-form-container text-left mx-auto">
              <form class="auth-form auth-signup-form" ref="registerform">
                ...
                <div class="password mb-3">
                  <label class="sr-only" for="signup-password">Password Repeat</label>
                  <input
                    id="password"
              ...
              <div class="auth-option text-center pt-5">
                ...
                <router-link class="text-link" :to="{name:'Login'}">Log in</router-link>
              </div>
            </div>
            <!--//auth-form-container-->
          </div>
