      ...
      <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
        <div class="d-flex flex-column align-content-end">
          <div class="app-auth-body mx-auto">
            ...
            <div
              class="auth-intro mb-4 text-center"
            >Enter your email address below. We'll email you a link to a page where you can easily create a new password.</div>
            ...
            <div class="auth-form-container text-left">
              ...
              <div class="auth-option text-center pt-5">
                <router-link class="app-link" :to="{name:'Login'}">Log in</router-link>
                <span class="px-2">|</span>
                <router-link class="app-link" :to="{name:'Register'}">Sign Up</router-link>
              </div>
            </div>
            <!--//auth-form-container-->
          </div>
...
export default {
  ...
  methods: {
    ...mapActions({
      sendResetPassword: "user/sendResetPassword",
    }),

    resetPassword() {
      const token = this.$route.query.token;

      this.sendResetPassword({ ...this.user, token })
        .then((response) => {
          Toast.fire({
            icon: "success",
